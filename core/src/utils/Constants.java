...
public class Constants {
	...
	// visible game world is 5 meters wide
		...
		//nombre de colonne maximal pour la g�n�ration d'alien
		public static final float MAXIMUM_COLONNE_ALIEN = 7.0f;
		
		//nombre de ligne maximal pour l a g�n�ration d'alien
		public static final float MAXIMUM_LIGNE_ALIEN = 5.0f;
		
		//nombre de colonne minimum pour la g�n�ration d'alien
		public static final float MINIMUM_COLONNE_ALIEN = 4.0f;
		
		//nombre de ligne minimum pour la g�n�ration d'alien
		...
		//dur�e entre chaque vague de missile
